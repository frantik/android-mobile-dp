...
import com.dvdprime.mobile.android.widget.CustomActivityChooserModel.OnChooseActivityListener;
...
public class CustomShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        CustomActivityChooserModel dataModel = CustomActivityChooserModel.get(mContext, mShareHistoryFileName);
        CustomActivityChooserView activityChooserView = new CustomActivityChooserView(mContext);
    ...
    public void setShareIntent(Intent shareIntent) {
        CustomActivityChooserModel dataModel = CustomActivityChooserModel.get(mContext,
