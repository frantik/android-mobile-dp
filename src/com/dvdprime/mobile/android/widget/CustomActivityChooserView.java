 ...
 */
package com.dvdprime.mobile.android.widget;
...
import com.dvdprime.mobile.android.widget.CustomActivityChooserModel.ActivityChooserModelClient;
 ...
 * <ul>
 * <li>
 * The left button is an immediate action and allows one click activity choosing. Tapping this button immediately executes the intent without requiring any further user input. Long press on this button shows a popup for changing the default activity.</li>
 * <li>
 * The right button is an overflow action and provides an optimized menu of additional activities. Tapping this button shows a popup anchored to this view, listing the most frequently used activities. This list is initially limited to a small number of items in frequency used order. The last item, "Show all..." serves as an affordance to display all available activities.</li>
 * </ul>
 * </p>
 * 
 * @hide
 */
class CustomActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
     ...
     * {@inheritDoc}
     */
    public void setActivityChooserModel(CustomActivityChooserModel dataModel) {
     ...
     * 
     * <strong>Note:</strong> Clients would like to set this drawable as a clue about the action the chosen activity will perform. For example, if a share activity is to be chosen the drawable should give a clue that sharing is to be performed.
     * 
     * @param drawable
     *            The drawable.
     */
     ...
     * 
     * description as a clue about the action performed by the button. For example, if a share activity is to be chosen the content description should be something like "Share with".
     * 
     * @param resourceId
    ...
    protected void onAttachedToWindow() {
        ...
        CustomActivityChooserModel dataModel = mAdapter.getDataModel();
        if (dataModel != null) {
            try {
    ...
    public CustomActivityChooserModel getDataModel() {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        private CustomActivityChooserModel mDataModel;
        ...
        public void setDataModel(CustomActivityChooserModel dataModel) {
            CustomActivityChooserModel oldDataModel = mAdapter.getDataModel();
